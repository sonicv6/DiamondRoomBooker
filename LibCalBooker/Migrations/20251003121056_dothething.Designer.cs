...
namespace LibCalBooker.Migrations
{
    ...
    [Migration("20251003121056_dothething")]
    partial class dothething
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LibCalBooker.Models.RecurringBooking", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("LibCalBooker.Models.Booking", b =>
                {
                    b.HasOne("LibCalBooker.Models.ApplicationUser", "Booker")
                        .WithMany("Bookings")
                        .HasForeignKey("BookerID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("LibCalBooker.Models.Room", "Room")
                        .WithMany("Bookings")
